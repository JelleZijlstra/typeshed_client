...
def register_adapter(
    __type: Type[_T], __caster: Callable[[_T], int | float | str | bytes]
) -> None: ...
...
class Connection(object):
    ...
    if sys.version_info >= (3, 8):
        def create_function(
            self, name: str, narg: int, func: Any, *, deterministic: bool = ...
        ) -> None: ...
    else:
...
class Cursor(Iterator[Any]):
    ...
    def executemany(
        self, __sql: str, __seq_of_parameters: Iterable[Iterable[Any]]
    ) -> Cursor: ...
    def executescript(self, __sql_script: bytes | str) -> Cursor: ...
