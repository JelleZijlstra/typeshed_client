...
class TestCase(Testable):
    ...
    def assertSetEqual(
        self,
        first: Set[Any] | FrozenSet[Any],
        second: Set[Any] | FrozenSet[Any],
        msg: object = ...,
    ) -> None: ...
    def assertDictEqual(
    ...
    def assertIsInstance(
        self, obj: Any, cls: type | Tuple[type, ...], msg: object = ...
    ) -> None: ...
    ...
    def _formatMessage(
        self, msg: Text | None, standardMsg: Text
    ) -> str: ...  # undocumented
...
class TestLoader:
    ...
    def loadTestsFromName(
        self, name: str = ..., module: types.ModuleType | None = ...
    ) -> TestSuite: ...
    def loadTestsFromNames(
        self, names: List[str] = ..., module: types.ModuleType | None = ...
    ) -> TestSuite: ...
    def discover(
...
def load_tests(
    loader: TestLoader, tests: TestSuite, pattern: Text | None
) -> TestSuite: ...
