...
class Shape(object):
    def __init__(
        self, type_: str, data: _PolygonCoords | PhotoImage | None = ...
    ) -> None: ...
    def addcomponent(
        self, poly: _PolygonCoords, fill: _Color, outline: _Color | None = ...
    ) -> None: ...
...
class TurtleScreen(TurtleScreenBase):
    ...
    def register_shape(
        self, name: str, shape: _PolygonCoords | Shape | None = ...
    ) -> None: ...
    @overload
    ...
    def onclick(
        self, fun: Callable[[float, float], Any], btn: int = ..., add: Any | None = ...
    ) -> None: ...
    def onkey(self, fun: Callable[[], Any], key: str) -> None: ...
    def listen(
        self, xdummy: float | None = ..., ydummy: float | None = ...
    ) -> None: ...
    ...
    @overload
    def screensize(
        self, canvwidth: int, canvheight: int, bg: _Color | None = ...
    ) -> None: ...
...
class TNavigator(object):
    ...
    def circle(
        self, radius: float, extent: float | None = ..., steps: int | None = ...
    ) -> None: ...
    fd = forward
    bk = back
    backward = back
...
class RawTurtle(TPen, TNavigator):
    def __init__(
        self,
        canvas: Canvas | TurtleScreen | None = ...,
        shape: str = ...,
        undobuffersize: int = ...,
        visible: bool = ...,
    ) -> None: ...
    ...
    def shapesize(
        self,
        stretch_wid: float | None = ...,
        stretch_len: float | None = ...,
        outline: float | None = ...,
    ) -> None: ...
    ...
    getpen = getturtle
    def onclick(
        self, fun: Callable[[float, float], Any], btn: int = ..., add: bool | None = ...
    ) -> None: ...
    def onrelease(
        self, fun: Callable[[float, float], Any], btn: int = ..., add: bool | None = ...
    ) -> None: ...
...
def onclick(
    fun: Callable[[float, float], Any], btn: int = ..., add: Any | None = ...
) -> None: ...
...
def circle(
    radius: float, extent: float | None = ..., steps: int | None = ...
) -> None: ...
