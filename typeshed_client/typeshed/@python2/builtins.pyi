...
class int:
    ...
    def __new__(
        cls: Type[_T],
        x: Text | bytes | SupportsInt | _SupportsIndex | _SupportsTrunc = ...,
    ) -> _T: ...
    @overload
...
class float:
    def __new__(
        cls: Type[_T],
        x: SupportsFloat | _SupportsIndex | Text | bytes | bytearray = ...,
    ) -> _T: ...
...
class unicode(basestring, Sequence[unicode]):
    ...
    def endswith(
        self,
        __suffix: unicode | Tuple[unicode, ...],
        __start: int | None = ...,
        __end: int | None = ...,
    ) -> bool: ...
    ...
    def rsplit(
        self, sep: unicode | None = ..., maxsplit: int = ...
    ) -> List[unicode]: ...
    ...
    def startswith(
        self,
        __prefix: unicode | Tuple[unicode, ...],
        __start: int | None = ...,
        __end: int | None = ...,
    ) -> bool: ...
...
class str(Sequence[str], basestring):
    ...
    def count(
        self, x: Text, __start: int | None = ..., __end: int | None = ...
    ) -> int: ...
    def decode(self, encoding: Text = ..., errors: Text = ...) -> unicode: ...
    def encode(self, encoding: Text = ..., errors: Text = ...) -> bytes: ...
    def endswith(
        self,
        __suffix: Text | Tuple[Text, ...],
        __start: int | None = ...,
        __end: int | None = ...,
    ) -> bool: ...
    def expandtabs(self, tabsize: int = ...) -> str: ...
    def find(
        self, sub: Text, __start: int | None = ..., __end: int | None = ...
    ) -> int: ...
    ...
    def title(self) -> str: ...
    def translate(
        self, __table: AnyStr | None, deletechars: AnyStr = ...
    ) -> AnyStr: ...
    def upper(self) -> str: ...
...
class bytearray(MutableSequence[int], ByteString):
    ...
    def rsplit(
        self, sep: bytes | None = ..., maxsplit: int = ...
    ) -> List[bytearray]: ...
...
def apply(
    __func: Callable[..., _T],
    __args: Sequence[Any] | None = ...,
    __kwds: Mapping[str, Any] | None = ...,
) -> _T: ...
...
def open(
    name: unicode | int, mode: unicode = ..., buffering: int = ...
) -> BinaryIO: ...
