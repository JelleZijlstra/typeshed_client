...
class _NNTPBase:
    ...
    def newgroups(
        self, date: datetime.date | datetime.datetime, *, file: _File = ...
    ) -> Tuple[str, List[str]]: ...
    def newnews(
        self, group: str, date: datetime.date | datetime.datetime, *, file: _File = ...
    ) -> Tuple[str, List[str]]: ...
    def list(
        self, group_pattern: str | None = ..., *, file: _File = ...
    ) -> Tuple[str, List[str]]: ...
    ...
    def over(
        self,
        message_spec: None | str | List[Any] | Tuple[Any, ...],
        *,
        file: _File = ...,
    ) -> Tuple[str, List[Tuple[int, Dict[str, str]]]]: ...
    def xgtitle(
    ...
    def quit(self) -> str: ...
    def login(
        self, user: str | None = ..., password: str | None = ..., usenetrc: bool = ...
    ) -> None: ...
