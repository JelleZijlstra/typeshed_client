...
@overload
def search(
    pattern: str | unicode, string: AnyStr, flags: int = ...
) -> Match[AnyStr] | None: ...
@overload
def search(
    pattern: Pattern[str] | Pattern[unicode], string: AnyStr, flags: int = ...
) -> Match[AnyStr] | None: ...
@overload
def match(
    pattern: str | unicode, string: AnyStr, flags: int = ...
...
@overload
def split(
    pattern: str | unicode, string: AnyStr, maxsplit: int = ..., flags: int = ...
) -> List[AnyStr]: ...
@overload
def split(
...
def purge() -> None: ...
def template(
    pattern: AnyStr | Pattern[AnyStr], flags: int = ...
) -> Pattern[AnyStr]: ...
