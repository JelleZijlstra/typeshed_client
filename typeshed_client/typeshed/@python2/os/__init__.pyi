...
def spawnle(
    mode: int, path: Text, arg0: bytes | Text, *args: Any
) -> int: ...  # Imprecise sig
def spawnv(mode: int, path: Text, args: List[bytes | Text]) -> int: ...
def spawnve(
    mode: int, path: Text, args: List[bytes | Text], env: Mapping[str, str]
) -> int: ...
...
if sys.platform == "win32":
    ...
    # Unix only
    def spawnlp(
        mode: int, file: Text, arg0: bytes | Text, *args: bytes | Text
    ) -> int: ...
    def spawnlpe(
        mode: int, file: Text, arg0: bytes | Text, *args: Any
    ) -> int: ...  # Imprecise signature
    def spawnvp(mode: int, file: Text, args: List[bytes | Text]) -> int: ...
    def spawnvpe(
        mode: int, file: Text, args: List[bytes | Text], env: Mapping[str, str]
    ) -> int: ...
