...
class DateTime:
    ...
    def __init__(
        self,
        value: str | unicode | datetime | float | int | _timeTuple | struct_time = ...,
    ) -> None: ...
...
def getparser(
    use_datetime: bool = ...,
) -> Tuple[ExpatParser | SlowParser, Unmarshaller]: ...
def dumps(
...
class Transport:
    ...
    def get_host_info(
        self, host: _hostDesc
    ) -> Tuple[str, List[Tuple[str, str]] | None, Mapping[Any, Any] | None]: ...
...
class SafeTransport(Transport):
    def __init__(
        self, use_datetime: bool = ..., context: SSLContext | None = ...
    ) -> None: ...
