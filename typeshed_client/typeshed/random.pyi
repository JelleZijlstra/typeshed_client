...
class Random(_random.Random):
    ...
    def shuffle(
        self, x: MutableSequence[Any], random: Callable[[], float] | None = ...
    ) -> None: ...
    if sys.version_info >= (3, 9):
        def sample(
            self,
            population: Sequence[_T] | Set[_T],
            k: int,
            *,
            counts: Iterable[_T] | None = ...,
        ) -> list[_T]: ...
    else:
    ...
    def triangular(
        self, low: float = ..., high: float = ..., mode: float | None = ...
    ) -> float: ...
...
def shuffle(
    x: MutableSequence[Any], random: Callable[[], float] | None = ...
) -> None: ...

if sys.version_info >= (3, 9):
    def sample(
        population: Sequence[_T] | Set[_T], k: int, *, counts: Iterable[_T] | None = ...
    ) -> list[_T]: ...
...
def triangular(
    low: float = ..., high: float = ..., mode: float | None = ...
) -> float: ...
