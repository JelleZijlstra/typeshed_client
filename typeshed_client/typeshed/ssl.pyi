...
_SrvnmeCbType = Callable[
    [Union[SSLSocket, SSLObject], Optional[str], SSLSocket], Optional[int]
]
...
def get_server_certificate(
    addr: tuple[str, int], ssl_version: int = ..., ca_certs: str | None = ...
) -> str: ...
...
class SSLSocket(socket.socket):
    ...
    def sendto(
        self,
        data: ReadableBuffer,
        flags_or_addr: int | socket._Address,
        addr: socket._Address | None = ...,
    ) -> int: ...
...
class SSLContext:
    ...
    ) -> list[_PeerCertRetDictType] | list[bytes]: ...
