...
class Variable:
    def __init__(
        self, master: Misc | None = ..., value: Any | None = ..., name: str | None = ...
    ) -> None: ...
...
class StringVar(Variable):
    def __init__(
        self, master: Misc | None = ..., value: str | None = ..., name: str | None = ...
    ) -> None: ...
...
class IntVar(Variable):
    def __init__(
        self, master: Misc | None = ..., value: int | None = ..., name: str | None = ...
    ) -> None: ...
...
class Misc:
    ...
    @overload
    def after(
        self, ms: int | Literal["idle"], func: Callable[..., Any], *args: Any
    ) -> str: ...
    ...
    def winfo_containing(
        self, rootX: int, rootY: int, displayof: Literal[0] | Misc | None = ...
    ) -> Misc | None: ...
    ...
    def winfo_interps(
        self, displayof: Literal[0] | Misc | None = ...
    ) -> Tuple[str, ...]: ...
    ...
    @overload
    def bind_all(
        self, sequence: str | None, func: str, add: bool | None = ...
    ) -> None: ...
    @overload
    ...
    @overload
    def bind_class(
        self, className: str, sequence: str | None, func: str, add: bool | None = ...
    ) -> None: ...
    @overload
    def bind_class(
        self, className: str, *, func: str, add: bool | None = ...
    ) -> None: ...
    ...
    def register(
        self,
        func: Callable[..., Any],
        subst: Callable[..., Sequence[Any]] | None = ...,
        needcleanup: int = ...,
    ) -> str: ...
    ...
    def grid_slaves(
        self, row: int | None = ..., column: int | None = ...
    ) -> list[Widget]: ...
...
class Wm:
    ...
    @overload
    def wm_attributes(
        self, __option: str, __value: Any, *__other_option_value_pairs: Any
    ) -> None: ...
...
class Canvas(Widget, XView, YView):
    ...
    def find_withtag(
        self, tagOrId: str | _CanvasItemId
    ) -> Tuple[_CanvasItemId, ...]: ...
    ...
    @overload
    def tag_bind(
        self, tagOrId: str | int, *, func: str, add: bool | None = ...
    ) -> None: ...
    def tag_unbind(
        self, tagOrId: str | int, sequence: str, funcid: str | None = ...
    ) -> None: ...
    ...
    def tag_lower(
        self, __first: str | _CanvasItemId, __second: str | _CanvasItemId | None = ...
    ) -> None: ...
...
class Menu(Widget):
    ...
    def add_separator(
        self, cnf: dict[str, Any] | None = ..., *, background: _Color = ...
    ) -> None: ...
    def insert_cascade(
        self,
        index: _MenuIndex,
...
class Text(Widget, XView, YView):
    ...
    def peer_create(
        self, newPathName: str | Text, cnf: dict[str, Any] = ..., **kw: Any
    ) -> None: ...
    ...
    @overload
    def tag_bind(
        self, tagName: str, sequence: str | None, func: str, add: bool | None = ...
    ) -> None: ...
    def tag_unbind(
        self, tagName: str, sequence: str, funcid: str | None = ...
    ) -> None: ...
    ...
    def tag_nextrange(
        self, tagName: str, index1: _TextIndex, index2: _TextIndex | None = ...
    ) -> tuple[str, str] | tuple[()]: ...
    def tag_prevrange(
        self, tagName: str, index1: _TextIndex, index2: _TextIndex | None = ...
    ) -> tuple[str, str] | tuple[()]: ...
...
class PhotoImage(Image):
    ...
    def write(
        ...
        format: str | None = ...,
        from_coords: tuple[int, int] | None = ...,
    ) -> None: ...
    if sys.version_info >= (3, 8):
