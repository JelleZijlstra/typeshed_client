...
class tixCommand:
    ...
    def tix_resetoptions(
        self, newScheme: str, newFontSet: str, newScmPrio: str | None = ...
    ) -> None: ...
...
class TixSubWidget(TixWidget):
    def __init__(
        ...
        name: str,
        destroy_physically: int = ...,
        check_intermediate: int = ...,
    ) -> None: ...
...
class Balloon(TixWidget):
    def __init__(
        self, master: tkinter.Widget | None = ..., cnf: dict[str, Any] = ..., **kw: Any
    ) -> None: ...
    def bind_widget(
        self, widget: tkinter.Widget, cnf: dict[str, Any] = ..., **kw: Any
    ) -> None: ...
...
class ButtonBox(TixWidget):
    ...
    def add(
        self, name: str, cnf: dict[str, Any] = ..., **kw: Any
    ) -> tkinter.Widget: ...
...
class HList(TixWidget, tkinter.XView, tkinter.YView):
    ...
    def add(
        self, entry: str, cnf: dict[str, Any] = ..., **kw: Any
    ) -> tkinter.Widget: ...
    def add_child(
        self, parent: str | None = ..., cnf: dict[str, Any] = ..., **kw: Any
    ) -> tkinter.Widget: ...
    def anchor_set(self, entry: str) -> None: ...
    def anchor_clear(self) -> None: ...
    # FIXME: Overload, certain combos return, others don't
    def column_width(
        self, col: int = ..., width: int | None = ..., chars: int | None = ...
    ) -> int | None: ...
    ...
    def header_configure(
        self, col: int, cnf: dict[str, Any] = ..., **kw: Any
    ) -> Any | None: ...
    ...
    def item_configure(
        self, entry: str, col: int, cnf: dict[str, Any] = ..., **kw: Any
    ) -> Any | None: ...
    def item_create(
        self, entry: str, col: int, cnf: dict[str, Any] = ..., **kw: Any
    ) -> None: ...
