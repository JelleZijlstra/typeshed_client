...
class Font:
    ...
    @overload
    def actual(
        self, option: Literal["family"], displayof: tkinter.Misc | None = ...
    ) -> str: ...
    @overload
    def actual(
        self, option: Literal["size"], displayof: tkinter.Misc | None = ...
    ) -> int: ...
    @overload
    def actual(
        self, option: Literal["weight"], displayof: tkinter.Misc | None = ...
    ) -> Literal["normal", "bold"]: ...
    @overload
    def actual(
        self, option: Literal["slant"], displayof: tkinter.Misc | None = ...
    ...
    @overload
    def actual(
        self, option: None, displayof: tkinter.Misc | None = ...
    ) -> _FontDict: ...
    @overload
    ...
    @overload
    def metrics(
        self, __option: Literal["fixed"], *, displayof: tkinter.Misc | None = ...
    ) -> bool: ...
    @overload
...
def families(
    root: tkinter.Misc | None = ..., displayof: tkinter.Misc | None = ...
) -> Tuple[str, ...]: ...
