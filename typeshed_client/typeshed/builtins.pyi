...
class staticmethod(Generic[_R]):  # Special, only valid as a decorator.
    ...
    def __get__(
        self, __obj: _T, __type: Type[_T] | None = ...
    ) -> Callable[..., _R]: ...
...
class int:
    ...
    def __new__(
        cls: Type[_T],
        __x: str | bytes | SupportsInt | SupportsIndex | _SupportsTrunc = ...,
    ) -> _T: ...
    @overload
    def __new__(
        cls: Type[_T], __x: str | bytes | bytearray, base: SupportsIndex
    ) -> _T: ...
    if sys.version_info >= (3, 8):
...
class bytes(ByteString):
    ...
    @overload
    def __new__(
        cls: Type[_T], __string: str, encoding: str, errors: str = ...
    ) -> _T: ...
    @overload
