...
if sys.version_info >= (3, 10):
    def as_completed(
        fs: Iterable[_FutureT[_T]], *, timeout: float | None = ...
    ) -> Iterator[Future[_T]]: ...
...
@overload
def ensure_future(
    coro_or_future: Awaitable[_T], *, loop: AbstractEventLoop | None = ...
) -> Task[_T]: ...
...
if sys.version_info >= (3, 10):
    @overload
    def gather(
        coro_or_future1: _FutureT[_T1], *, return_exceptions: Literal[False] = ...
    ) -> Future[tuple[_T1]]: ...
    @overload
    def gather(
    ...
    @overload
    def gather(
        coro_or_future1: _FutureT[_T1], *, return_exceptions: bool = ...
...
if sys.version_info >= (3, 10):
    ...
    def shield(
        arg: _FutureT[_T], *, loop: AbstractEventLoop | None = ...
    ) -> Future[_T]: ...
    def sleep(
        delay: float, result: _T = ..., *, loop: AbstractEventLoop | None = ...
    ) -> Future[_T]: ...
    @overload
...
class Task(Future[_T], Generic[_T]):
    ...
    def print_stack(
        self, *, limit: int | None = ..., file: TextIO | None = ...
    ) -> None: ...
    if sys.version_info >= (3, 9):
    ...
    if sys.version_info < (3, 9):
        @classmethod
        def current_task(
            cls, loop: AbstractEventLoop | None = ...
        ) -> Task[Any] | None: ...
        @classmethod
