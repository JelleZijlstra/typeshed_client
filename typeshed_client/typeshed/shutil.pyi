...
def chown(
    path: StrPath, user: str | int | None = ..., group: str | int | None = ...
) -> None: ...

if sys.version_info >= (3, 8):
    @overload
    def which(
        cmd: StrPath, mode: int = ..., path: StrPath | None = ...
    ) -> str | None: ...
    @overload
    def which(
        cmd: bytes, mode: int = ..., path: StrPath | None = ...
    ) -> bytes | None: ...
...
if sys.version_info >= (3, 7):
    def unpack_archive(
        filename: StrPath, extract_dir: StrPath | None = ..., format: str | None = ...
    ) -> None: ...

else:
    # See http://bugs.python.org/issue30218
    def unpack_archive(
        filename: str, extract_dir: StrPath | None = ..., format: str | None = ...
    ) -> None: ...
