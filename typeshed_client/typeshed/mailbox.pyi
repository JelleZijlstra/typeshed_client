...
class Mailbox(Generic[_MessageT]):
    ...
    def __init__(
        self,
        path: StrOrBytesPath,
        factory: Callable[[IO[Any]], _MessageT] | None = ...,
        create: bool = ...,
    ) -> None: ...
...
class Maildir(Mailbox[MaildirMessage]):
    ...
    def __init__(
        self,
        dirname: StrOrBytesPath,
        factory: Callable[[IO[Any]], MaildirMessage] | None = ...,
        create: bool = ...,
    ) -> None: ...
...
class mbox(_mboxMMDF[mboxMessage]):
    def __init__(
        self,
        path: StrOrBytesPath,
        factory: Callable[[IO[Any]], mboxMessage] | None = ...,
        create: bool = ...,
    ) -> None: ...
...
class MMDF(_mboxMMDF[MMDFMessage]):
    def __init__(
        self,
        path: StrOrBytesPath,
        factory: Callable[[IO[Any]], MMDFMessage] | None = ...,
        create: bool = ...,
    ) -> None: ...
...
class MH(Mailbox[MHMessage]):
    def __init__(
        self,
        path: StrOrBytesPath,
        factory: Callable[[IO[Any]], MHMessage] | None = ...,
        create: bool = ...,
    ) -> None: ...
    def get_file(self, key: str) -> _ProxyFile[bytes]: ...
    def list_folders(self) -> list[str]: ...
...
class Babyl(_singlefileMailbox[BabylMessage]):
    def __init__(
        self,
        path: StrOrBytesPath,
        factory: Callable[[IO[Any]], BabylMessage] | None = ...,
        create: bool = ...,
    ) -> None: ...
...
class _mboxMMDFMessage(Message):
    ...
    def set_from(
        self,
        from_: str,
        time_: bool | tuple[int, int, int, int, int, int, int, int, int] | None = ...,
    ) -> None: ...
    def get_flags(self) -> str: ...
    def set_flags(self, flags: Iterable[str]) -> None: ...
    def add_flag(self, flag: str) -> None: ...
...
class _PartialFile(_ProxyFile[AnyStr]):
    def __init__(
        self, f: IO[AnyStr], start: int | None = ..., stop: int | None = ...
    ) -> None: ...
