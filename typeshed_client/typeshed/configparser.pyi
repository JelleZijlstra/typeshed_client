...
class RawConfigParser(_parser):
    ...
    def read(
        self, filenames: _Path | Iterable[_Path], encoding: str | None = ...
    ) -> list[str]: ...
    ...
    @overload
    def getint(
        self, section: str, option: str, *, raw: bool = ..., vars: _section | None = ...
    ) -> int: ...
    @overload
    def getint(
        self,
    ...
    @overload
    def items(
        self, *, raw: bool = ..., vars: _section | None = ...
    ) -> ItemsView[str, SectionProxy]: ...
    @overload
    def items(
        self, section: str, raw: bool = ..., vars: _section | None = ...
    ) -> list[tuple[str, str]]: ...
...
class DuplicateSectionError(Error):
    ...
    lineno: int | None
    def __init__(
        self, section: str, source: str | None = ..., lineno: int | None = ...
    ) -> None: ...
...
class ParsingError(Error):
    ...
    def __init__(
        self, source: str | None = ..., filename: str | None = ...
    ) -> None: ...
