...
class RefactoringTool:
    ...
    def refactor(
        self, items: Iterable[str], write: bool = ..., doctests_only: bool = ...
    ) -> None: ...
    def refactor_dir(
        self, dir_name: str, write: bool = ..., doctests_only: bool = ...
    ) -> None: ...
    def _read_python_source(self, filename: str) -> tuple[str, str]: ...
    def refactor_file(
        self, filename: str, write: bool = ..., doctests_only: bool = ...
    ) -> None: ...
    ...
    def write_file(
        self, new_text: str, filename: str, old_text: str, encoding: str | None = ...
    ) -> None: ...
    PS1: ClassVar[str]
    PS2: ClassVar[str]
    def refactor_docstring(self, input: str, filename: str) -> str: ...
    def refactor_doctest(
        self, block: list[str], lineno: int, indent: int, filename: str
    ) -> list[str]: ...
    ...
    def wrap_toks(
        ...
        tuple[Any, Any, tuple[int, int], tuple[int, int], str], None, None
    ]: ...
    def gen_lines(
