...
class UserDict(MutableMapping[_KT, _VT]):
    data: dict[_KT, _VT]
    def __init__(
        self, __dict: Mapping[_KT, _VT] | None = ..., **kwargs: _VT
    ) -> None: ...
    ...
    @classmethod
    def fromkeys(
        cls: Type[_S], iterable: Iterable[_KT], value: _VT | None = ...
    ) -> _S: ...
...
class UserString(Sequence[str]):
    ...
    if sys.version_info >= (3, 8):
        def encode(
            self: UserString, encoding: str | None = ..., errors: str | None = ...
        ) -> bytes: ...
    else:
        def encode(
            self: _UserStringT, encoding: str | None = ..., errors: str | None = ...
        ) -> _UserStringT: ...
    def endswith(
        self,
    ...
    if sys.version_info >= (3, 9):
        def removeprefix(
            self: _UserStringT, __prefix: str | UserString
        ) -> _UserStringT: ...
        def removesuffix(
            self: _UserStringT, __suffix: str | UserString
        ) -> _UserStringT: ...
    def replace(
        self: _UserStringT,
        old: str | UserString,
    ...
    def rindex(
        self, sub: str | UserString, start: int = ..., end: int = ...
    ) -> int: ...
...
class Counter(Dict[_T, int], Generic[_T]):
    ...
    @overload
    def update(
        self, __m: Iterable[_T] | Iterable[tuple[_T, int]], **kwargs: int
    ) -> None: ...
    @overload
...
class _OrderedDictItemsView(
    _dict_items[_KT_co, _VT_co], Reversible[Tuple[_KT_co, _VT_co]]
):
    def __reversed__(self) -> Iterator[tuple[_KT_co, _VT_co]]: ...

class _OrderedDictValuesView(
    _dict_values[_KT_co, _VT_co], Reversible[_VT_co], Generic[_KT_co, _VT_co]
):
...
class defaultdict(Dict[_KT, _VT], Generic[_KT, _VT]):
    ...
    @overload
    def __init__(
        self, default_factory: Callable[[], _VT] | None, **kwargs: _VT
    ) -> None: ...
    @overload
    def __init__(
        self, default_factory: Callable[[], _VT] | None, map: Mapping[_KT, _VT]
    ) -> None: ...
    @overload
    def __init__(
        self,
