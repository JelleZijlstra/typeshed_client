...
class Decimal(object):
    def __new__(
        cls: Type[_DecimalT], value: _DecimalNew = ..., context: Context | None = ...
    ) -> _DecimalT: ...
    @classmethod
    ...
    def remainder_near(
        self, other: _Decimal, context: Context | None = ...
    ) -> Decimal: ...
...
class Context(object):
    ...
    def power(
        self, a: _Decimal, b: _Decimal, modulo: _Decimal | None = ...
    ) -> Decimal: ...
