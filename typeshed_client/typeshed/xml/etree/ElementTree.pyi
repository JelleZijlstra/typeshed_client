...
class Element(MutableSequence[Element]):
    ...
    @overload
    def findtext(
        self, path: str, default: None = ..., namespaces: dict[str, str] | None = ...
    ) -> str | None: ...
    @overload
    def findtext(
        self, path: str, default: _T, namespaces: dict[str, str] | None = ...
    ) -> _T | str: ...
    @overload
...
class ElementTree:
    def __init__(
        self, element: Element | None = ..., file: _File | None = ...
    ) -> None: ...
...
if sys.version_info >= (3, 9):
    def indent(
        tree: Element | ElementTree, space: str = ..., level: int = ...
    ) -> None: ...
...
class XMLPullParser:
    def __init__(
        self, events: Sequence[str] | None = ..., *, _parser: XMLParser | None = ...
    ) -> None: ...
...
def XMLID(
    text: str | bytes, parser: XMLParser | None = ...
...
def fromstringlist(
    sequence: Sequence[str | bytes], parser: XMLParser | None = ...
) -> Element: ...
...
class TreeBuilder:
    ...
    def start(
        self, __tag: str | bytes, __attrs: dict[str | bytes, str | bytes]
    ) -> Element: ...
...
class XMLParser:
    ...
    if sys.version_info >= (3, 8):
        def __init__(
            self, *, target: Any = ..., encoding: str | None = ...
        ) -> None: ...
    else:
        def __init__(
