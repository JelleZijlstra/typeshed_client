...
def parse(
    file: str | IO[Any], parser: XMLReader | None = ..., bufsize: int | None = ...
): ...
...
class Node(xml.dom.Node):
    ...
    if sys.version_info >= (3, 9):
        ...
        def toprettyxml(
            self, indent: str = ..., newl: str = ..., encoding: Any | None = ...
        ): ...
...
class DOMImplementation(DOMImplementationLS):
    ...
    def createDocument(
        self, namespaceURI: str | None, qualifiedName: str | None, doctype
    ): ...
