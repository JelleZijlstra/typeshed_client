...
def visiblename(
    name: str, all: Container[str] | None = ..., obj: object | None = ...
) -> bool: ...
...
class Doc:
    ...
    def docproperty(
        self, object: object, name: str | None = ..., *args: Any
    ) -> str: ...
...
class HTMLDoc(Doc):
    ...
    def index(
        self, dir: str, shadowed: MutableMapping[str, bool] | None = ...
    ) -> str: ...
...
class Helper:
    ...
    def __init__(
        self, input: IO[str] | None = ..., output: IO[str] | None = ...
    ) -> None: ...
    input: IO[str]
    output: IO[str]
