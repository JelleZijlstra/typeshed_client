...
class TestFinder(unittest.TestCase):
    def test_get_stub_file(self) -> None:
        ...
        self.assertEqual(get_stub_file('lib', version=(3, 6)),
                         TEST_TYPESHED / 'stdlib/3.5/lib.pyi')
        self.assertEqual(get_stub_file('lib', version=(3, 5)),
                         TEST_TYPESHED / 'stdlib/3.5/lib.pyi')
        self.assertEqual(get_stub_file('lib', version=(3, 4)),
                         TEST_TYPESHED / 'stdlib/3.4/lib.pyi')
        self.assertEqual(get_stub_file('lib', version=(3, 3)),
                         TEST_TYPESHED / 'stdlib/3.3/lib.pyi')
        self.assertEqual(get_stub_file('lib', version=(3, 2)),
    ...
    def test_third_party(self) -> None:
        self.assertEqual(get_stub_file('thirdpart', version=(3, 5)),
                         TEST_TYPESHED / 'third_party/3.5/thirdpart.pyi')
        self.assertEqual(get_stub_file('thirdpart', version=(3, 4)),
